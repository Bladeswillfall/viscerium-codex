...
test('the Codex navigation footer is a sticky viewport-wide underlay', () => {
  ...
  assert.match(footer, /\.ion-codex-footer::before\s*\{[\s\S]*?inline-size:\s*3\.375rem[\s\S]*?block-size:\s*0\.1875rem/);
});
