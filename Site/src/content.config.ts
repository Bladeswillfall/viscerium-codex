  ...
  docs: defineCollection({
    ...
    schema: docsSchema({
      extend: pageSiteGraphSchema.merge(starlightTagsExtension).extend({
        ...
        leader: stringOrStrings.optional(),
        government: stringOrStrings.optional(),
        founding: stringOrStrings.optional(),
        region: stringOrStrings.optional(),
        population: stringOrStrings.optional(),
        climate: stringOrStrings.optional(),
        participants: stringOrStrings.optional(),
        outcome: stringOrStrings.optional(),
        start: stringOrStrings.optional(),
        end: stringOrStrings.optional(),
        timelineId: optionalString,
