...
The visible year above is a leap year so that both Engimanutur days are shown. The underlying engine still calculates ordinary years and leap years separately.
