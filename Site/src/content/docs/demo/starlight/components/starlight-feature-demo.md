...
next: false
pagefind: false
sourcePath: "Demo/Starlight/Components/Starlight Feature Demo.md"
---
...
:::note[Demo intent]
This file is plain Markdown again so it should behave cleanly in Obsidian. The calendar above is rendered by the site layout from `calendarShowcase` frontmatter, not by importing MDX components into the note.
:::

## Calendar frontmatter check

This page includes two structured calendar blocks in frontmatter:
...
Expected result: the page title area should show an automatic event-date badge and the full Okse calendar showcase.
...
- [ ] The full Okse calendar grid renders from frontmatter.
